...
private extension String {
    ...
    func isReservedKeyword(lang : Runtime.ExportLanguage) -> Bool {
        ...
        return keywords.firstIndex(of: self) != nil
    }
}
...
class Localization {
    ...
    func writerWithSwiftImplementation() -> StreamWriter {
        ...
        // DummyClass
        writer.writeMarkWithName(name: "DummyClass")
        writer.store(string: "private class DummyClass {}\n")
        writer.store(string: "private let currentBundle = Bundle(for: DummyClass.self)\n")
...
class StreamWriter {
    ...
    fileprivate func store(string : String) {
...
class TemplateFactory {
    ...
    class func templateForSwiftStaticVarWithName(name : String, key : String, table: String?, baseTranslation : String, contentLevel : Int) -> String {
        ...
        return TemplateFactory.contentIndentForLevel(contentLevel: contentLevel) + "/// Base translation: \(baseTranslation)\n"
            + TemplateFactory.contentIndentForLevel(contentLevel: contentLevel) + "public static var \(name) : String = NSLocalizedString(\"\(key)\", bundle: currentBundle, \(tableName)comment: \"\")\n"
    }
    ...
    class func templateForSwiftFuncWithName(name : String, key : String, table: String?, baseTranslation : String, methodHeader : String, params : String, contentLevel : Int) -> String {
        ...
        return TemplateFactory.contentIndentForLevel(contentLevel: contentLevel) + "/// Base translation: \(baseTranslation)\n"
             ...
             + TemplateFactory.contentIndentForLevel(contentLevel: contentLevel + 1) + "return String(format: NSLocalizedString(\"\(key)\", bundle: currentBundle, \(tableName)comment: \"\"), \(params))\n"
             + TemplateFactory.contentIndentForLevel(contentLevel: contentLevel) + "}\n"
    }
