...
public extension TDEnum {
    enum InputInlineQueryResult: TDEnumProtocol {
        ...
        ///  - thumbnailUrl: URL of the static result thumbnail (JPEG or GIF), if
        /// it exists
        ...
        ///  - inputMessageContent: The content of the message to be sent. Must be
        /// one of the following types: InputMessageText, InputMessageAnimation,
        ...
        /// replyMarkupInlineKeyboard or null
        ///  - inputMessageContent: The content of the message to be sent. Must be
        /// one of the following types: InputMessageText, InputMessageLocation,
        ...
        /// replyMarkupInlineKeyboard or null
        ///  - inputMessageContent: The content of the message to be sent. Must be
        /// one of the following types: InputMessageText, InputMessageAudio,
        /// InputMessageLocation, InputMessageVenue or InputMessageContact
        ...
        /// replyMarkupInlineKeyboard or null
        ///  - inputMessageContent: The content of the message to be sent. Must be
        /// one of the following types: InputMessageText, InputMessageDocument,
        /// InputMessageLocation, InputMessageVenue or InputMessageContact
        ...
        ///  - livePeriod: Amount of time relative to the message sent time until
        ...
        ///  - photoUrl: The URL of the JPEG photo (photo size must not exceed
        /// 5MB)
        ...
        /// replyMarkupInlineKeyboard or null
        ///  - inputMessageContent: The content of the message to be sent. Must be
        /// one of the following types: InputMessageText, InputMessagePhoto,
        /// InputMessageLocation, InputMessageVenue or InputMessageContact
        ...
        ///  - stickerUrl: The URL of the WEBP sticker (sticker file size must not
        /// exceed 5MB)
        ...
        /// replyMarkupInlineKeyboard or null
        ///  - inputMessageContent: The content of the message to be sent. Must be
        /// one of the following types: InputMessageText, inputMessageSticker,
        /// InputMessageLocation, InputMessageVenue or InputMessageContact
        ...
        ///  - mimeType: MIME type of the content of the video URL, only
        /// "text/html" or "video/mp4" are currently supported
        ...
        /// replyMarkupInlineKeyboard or null
        ///  - inputMessageContent: The content of the message to be sent. Must be
        /// one of the following types: InputMessageText, InputMessageVideo,
        /// InputMessageLocation, InputMessageVenue or InputMessageContact
        ...
        /// replyMarkupInlineKeyboard or null
        ///  - inputMessageContent: The content of the message to be sent. Must be
        /// one of the following types: InputMessageText, InputMessageVoiceNote,
        /// InputMessageLocation, InputMessageVenue or InputMessageContact
