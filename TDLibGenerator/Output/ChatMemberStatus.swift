...
public extension TDEnum {
    enum ChatMemberStatus: TDEnumProtocol {
        ///  The user is the creator of a chat and has all the administrator
        /// privileges
        ///
        ...
        ///  - canChangeInfo: True, if the administrator can change the chat
        /// title, photo, and other settings
        ///  - canPostMessages: True, if the administrator can create channel
        /// posts; applicable to channels only
        ///  - canEditMessages: True, if the administrator can edit messages of
        /// other users and pin messages; applicable to channels only
        ///  - canDeleteMessages: True, if the administrator can delete messages
        /// of other users
        ///  - canInviteUsers: True, if the administrator can invite new users to
        /// the chat
        ///  - canRestrictMembers: True, if the administrator can restrict, ban,
        ...
        /// administrators that were directly or indirectly promoted by him
        ...
        ///
        ///  - isMember: True, if the user is a member of the chat
        ///  - restrictedUntilDate: Point in time (Unix timestamp) when
        ...
        ///  - canSendMessages: True, if the user can send text messages,
        /// contacts, locations, and venues
        ///  - canSendMediaMessages: True, if the user can send audio files,
        ...
        /// and stickers and use inline bots. Implies can_send_media_messages
        /// permissions
        ///  - canAddWebPagePreviews: True, if the user may add a web page preview
        /// to his messages. Implies can_send_messages permissions
        ...
        ///
        ///  - bannedUntilDate: Point in time (Unix timestamp) when the user will
        /// be unbanned; 0 if never. If the user is banned for more than 366 days
