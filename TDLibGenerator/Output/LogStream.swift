...
public extension TDEnum {
    enum LogStream: TDEnumProtocol {
        ...
        ///
        ///  - path: Path to the file to where the internal TDLib log will be
        /// written
        ///  - maxFileSize: Maximum size of the file to where the internal TDLib
        /// log is written before the file will be auto-rotated
