...
try container.encode("chatTypePrivate", forKey: .init(string: "@type"))

try container.encode(userId, forKey: .init(string: "userId"))

try container.encode("chatTypeBasicGroup", forKey: .init(string: "@type"))

try container.encode(basicGroupId, forKey: .init(string: "basicGroupId"))

try container.encode("chatTypeSupergroup", forKey: .init(string: "@type"))
...
try container.encode("chatTypeSecret", forKey: .init(string: "@type"))
