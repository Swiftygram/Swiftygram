...
case .androidPay(let data):
case .new(let data, let allowSave):
case .saved(let savedCredentialsId):
try container.encode("inputCredentialsSaved", forKey: .init(string: "@type"))

try container.encode(savedCredentialsId, forKey: .init(string: "savedCredentialsId"))

try container.encode("inputCredentialsNew", forKey: .init(string: "@type"))

try container.encode(data, forKey: .init(string: "data"))
try container.encode(allowSave, forKey: .init(string: "allowSave"))

try container.encode("inputCredentialsAndroidPay", forKey: .init(string: "@type"))

try container.encode(data, forKey: .init(string: "data"))

try container.encode("inputCredentialsApplePay", forKey: .init(string: "@type"))
