...
case .discarded(let reason, let needRating, let needDebugInformation):
case .hangingUp:
case .ready(let protocol, let connections, let config, let encryptionKey, let emojis, let allowP2P):
case .exchangingKeys:
case .pending(let isCreated, let isReceived):
try container.encode("callStatePending", forKey: .init(string: "@type"))

try container.encode(isCreated, forKey: .init(string: "isCreated"))
try container.encode(isReceived, forKey: .init(string: "isReceived"))

try container.encode("callStateExchangingKeys", forKey: .init(string: "@type"))

try container.encode("callStateReady", forKey: .init(string: "@type"))
...
try container.encode("callStateHangingUp", forKey: .init(string: "@type"))

try container.encode("callStateDiscarded", forKey: .init(string: "@type"))
...
try container.encode("callStateError", forKey: .init(string: "@type"))
