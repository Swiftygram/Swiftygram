...
try container.encode("authenticationCodeTypeTelegramMessage", forKey: .init(string: "@type"))

try container.encode(length, forKey: .init(string: "length"))

try container.encode("authenticationCodeTypeSms", forKey: .init(string: "@type"))

try container.encode(length, forKey: .init(string: "length"))

try container.encode("authenticationCodeTypeCall", forKey: .init(string: "@type"))

try container.encode(length, forKey: .init(string: "length"))

try container.encode("authenticationCodeTypeFlashCall", forKey: .init(string: "@type"))
