...
public extension TDEnum {
    enum AuthorizationState: TDEnumProtocol {
        ...
        ///  - termsOfService: Telegram terms of service, which should be accepted
        /// before user can continue registration; may be null
        ...
        ///  - hasRecoveryEmailAddress: True if a recovery email address has been
        /// set up
        ///  - recoveryEmailAddressPattern: Pattern of the email address to which
        /// the recovery email was sent; empty until a recovery email has been
        /// sent
        ...
        /// working, one should create a new instance of the TDLib client
        case closed
