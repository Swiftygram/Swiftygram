...
public extension TDEnum {
    enum InputFile: TDEnumProtocol {
        ...
        ///
        ///  - originalPath: Local path to a file from which the file is
        /// generated; may be empty if there is no such file
        ///  - conversion: String specifying the conversion applied to the
        /// original file; should be persistent across application restarts.
