...
public extension TDEnum {
    enum LinkState: TDEnumProtocol {
        ...
        ///  The phone number of user A is known but that number has not been
        /// saved to the contact list of user B
        case knowsPhoneNumber

        ///  The phone number of user A has been saved to the contact list of user
        /// B
        case isContact
