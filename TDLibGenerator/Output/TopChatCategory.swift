...
public extension TDEnum {
    enum TopChatCategory: TDEnumProtocol {
        ///  A category containing frequently used private chats with non-bot
        /// users
        case users
        ...
        ///  A category containing frequently used chats with inline bots sorted
        /// by their usage in inline mode
        case inlineBots
