...
switch self {
case .unknown:
case .bot(let canJoinGroups, let canReadAllGroupMessages, let isInline, let inlineQueryPlaceholder, let needLocation):
case .deleted:
case .regular:
try container.encode("userTypeRegular", forKey: .init(string: "@type"))

try container.encode("userTypeDeleted", forKey: .init(string: "@type"))

try container.encode("userTypeBot", forKey: .init(string: "@type"))
...
try container.encode("userTypeUnknown", forKey: .init(string: "@type"))
