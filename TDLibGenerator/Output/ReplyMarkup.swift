...
public extension TDEnum {
    enum ReplyMarkup: TDEnumProtocol {
        ...
        /// sent
        ///
        ///  - isPersonal: True, if the keyboard is removed only for the mentioned
        /// users or the target user of a reply
        case removeKeyboard(isPersonal: Bool)

        ///  Instructs clients to force a reply to this message
        ///
        ///  - isPersonal: True, if a forced reply must automatically be shown to
        /// the current user. For outgoing messages, specify true to show the
        ...
        ///  - resizeKeyboard: True, if the client needs to resize the keyboard
        /// vertically
        ///  - oneTime: True, if the client needs to hide the keyboard after use
        ///  - isPersonal: True, if the keyboard must automatically be shown to
        /// the current user. For outgoing messages, specify true to show the
