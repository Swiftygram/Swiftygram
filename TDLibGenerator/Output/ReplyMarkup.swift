...
switch self {
case .inlineKeyboard(let rows):
case .showKeyboard(let rows, let resizeKeyboard, let oneTime, let isPersonal):
case .forceReply(let isPersonal):
case .removeKeyboard(let isPersonal):
try container.encode("replyMarkupRemoveKeyboard", forKey: .init(string: "@type"))

try container.encode(isPersonal, forKey: .init(string: "isPersonal"))

try container.encode("replyMarkupForceReply", forKey: .init(string: "@type"))

try container.encode(isPersonal, forKey: .init(string: "isPersonal"))

try container.encode("replyMarkupShowKeyboard", forKey: .init(string: "@type"))
...
try container.encode("replyMarkupInlineKeyboard", forKey: .init(string: "@type"))
