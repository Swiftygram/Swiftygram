...
public extension TDEnum {
    enum MessageContent: TDEnumProtocol {
        ...
        ///  - isSecret: True, if the photo must be blurred and must be shown only
        /// while tapped
        ...
        ///  - isSecret: True, if the video thumbnail must be blurred and the
        ...
        ///  - isViewed: True, if at least one of the recipients has viewed the
        /// video note
        ///  - isSecret: True, if the video note thumbnail must be blurred and the
        /// video note must be shown only while tapped
        ...
        ///  - isListened: True, if at least one of the recipients has listened to
        /// the voice note
        ...
        ///  - livePeriod: Time relative to the message sent date until which the
        /// location can be updated, in seconds
        ///  - expiresIn: Left time for which the location can be updated, in
        ...
        ///  - totalAmount: Product total price in the minimal quantity of the
        /// currency
        ///  - startParameter: Unique invoice bot start_parameter. To share an
        /// invoice use the URL
        /// https://t.me/{bot_username}?start={start_parameter}
        ///  - isTest: True, if the invoice is a test invoice
        ///  - needShippingAddress: True, if the shipping address should be
        /// specified
        ///  - receiptMessageId: The identifier of the message with the receipt,
        ...
        /// result
        ///
        ///  - supergroupId: Identifier of the supergroup to which the basic group
        /// was upgraded
        ...
        ///
        ///  - messageId: Identifier of the pinned message, can be an identifier
        /// of a deleted message or 0
        ...
        ///  - gameId: Identifier of the game; may be different from the games
        ...
        ///  - totalAmount: Total price for the product, in the minimal quantity
        /// of the currency
        ...
        ///  - shippingOptionId: Identifier of the shipping option chosen by the
        /// user; may be empty if not applicable
