...
switch self {
case .mediaAlbum(let totalCount, let hasPhotos, let hasVideos):
case .messageForwards(let totalCount):
case .chatJoinByLink:
case .chatDeleteMember(let memberName, let isCurrentUser, let isLeft):
case .chatChangeTitle(let title):
case .chatChangePhoto:
case .chatAddMembers(let memberName, let isCurrentUser, let isReturned):
case .basicGroupChatCreate:
case .voiceNote(let voiceNote, let isPinned):
case .videoNote(let videoNote, let isPinned):
case .video(let video, let caption, let isSecret, let isPinned):
case .text(let text, let isPinned):
case .sticker(let sticker, let emoji, let isPinned):
case .screenshotTaken:
case .poll(let question, let isPinned):
case .photo(let photo, let caption, let isSecret, let isPinned):
case .location(let isLive, let isPinned):
case .invoice(let price, let isPinned):
case .gameScore(let title, let score, let isPinned):
case .game(let title, let isPinned):
case .document(let document, let isPinned):
case .contactRegistered:
case .contact(let name, let isPinned):
case .audio(let audio, let isPinned):
case .animation(let animation, let caption, let isPinned):
case .hidden(let isPinned):
try container.encode("pushMessageContentHidden", forKey: .init(string: "@type"))

try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentAnimation", forKey: .init(string: "@type"))

try container.encode(animation, forKey: .init(string: "animation"))
try container.encode(caption, forKey: .init(string: "caption"))
try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentAudio", forKey: .init(string: "@type"))

try container.encode(audio, forKey: .init(string: "audio"))
try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentContact", forKey: .init(string: "@type"))

try container.encode(name, forKey: .init(string: "name"))
try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentContactRegistered", forKey: .init(string: "@type"))

try container.encode("pushMessageContentDocument", forKey: .init(string: "@type"))

try container.encode(document, forKey: .init(string: "document"))
try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentGame", forKey: .init(string: "@type"))

try container.encode(title, forKey: .init(string: "title"))
try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentGameScore", forKey: .init(string: "@type"))

try container.encode(title, forKey: .init(string: "title"))
try container.encode(score, forKey: .init(string: "score"))
try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentInvoice", forKey: .init(string: "@type"))

try container.encode(price, forKey: .init(string: "price"))
try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentLocation", forKey: .init(string: "@type"))

try container.encode(isLive, forKey: .init(string: "isLive"))
try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentPhoto", forKey: .init(string: "@type"))
...
try container.encode("pushMessageContentPoll", forKey: .init(string: "@type"))

try container.encode(question, forKey: .init(string: "question"))
try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentScreenshotTaken", forKey: .init(string: "@type"))

try container.encode("pushMessageContentSticker", forKey: .init(string: "@type"))

try container.encode(sticker, forKey: .init(string: "sticker"))
try container.encode(emoji, forKey: .init(string: "emoji"))
try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentText", forKey: .init(string: "@type"))

try container.encode(text, forKey: .init(string: "text"))
try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentVideo", forKey: .init(string: "@type"))
...
try container.encode("pushMessageContentVideoNote", forKey: .init(string: "@type"))

try container.encode(videoNote, forKey: .init(string: "videoNote"))
try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentVoiceNote", forKey: .init(string: "@type"))

try container.encode(voiceNote, forKey: .init(string: "voiceNote"))
try container.encode(isPinned, forKey: .init(string: "isPinned"))

try container.encode("pushMessageContentBasicGroupChatCreate", forKey: .init(string: "@type"))

try container.encode("pushMessageContentChatAddMembers", forKey: .init(string: "@type"))
...
try container.encode("pushMessageContentChatChangePhoto", forKey: .init(string: "@type"))

try container.encode("pushMessageContentChatChangeTitle", forKey: .init(string: "@type"))

try container.encode(title, forKey: .init(string: "title"))

try container.encode("pushMessageContentChatDeleteMember", forKey: .init(string: "@type"))

try container.encode(memberName, forKey: .init(string: "memberName"))
try container.encode(isCurrentUser, forKey: .init(string: "isCurrentUser"))
try container.encode(isLeft, forKey: .init(string: "isLeft"))

try container.encode("pushMessageContentChatJoinByLink", forKey: .init(string: "@type"))

try container.encode("pushMessageContentMessageForwards", forKey: .init(string: "@type"))

try container.encode(totalCount, forKey: .init(string: "totalCount"))

try container.encode("pushMessageContentMediaAlbum", forKey: .init(string: "@type"))
