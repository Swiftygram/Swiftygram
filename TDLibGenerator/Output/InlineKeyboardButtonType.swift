...
public extension TDEnum {
    enum InlineKeyboardButtonType: TDEnumProtocol {
        ...
        ///  - inCurrentChat: True, if the inline query should be sent from the
        /// current chat
        case switchInline(query: String, inCurrentChat: Bool)

        ///  A button to buy something. This button must be in the first column
        /// and row of the keyboard and can be attached only to a message with
