...
public extension TDEnum {
    enum MessageForwardOrigin: TDEnumProtocol {
        ...
        ///
        ///  - senderUserId: Identifier of the user that originally sent the
        /// message
        case user(senderUserId: Int)

        ///  The message was originally written by a user, which is hidden by his
        /// privacy settings
        ///
        ...
        ///
        ///  - chatId: Identifier of the chat from which the message was
