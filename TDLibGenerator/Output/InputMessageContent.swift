...
public extension TDEnum {
    enum InputMessageContent: TDEnumProtocol {
        ...
        /// Code, Pre, PreCode and TextUrl entities are allowed to be specified
        /// manually
        ///  - disableWebPagePreview: True, if rich web page previews for URLs in
        /// the message text should be disabled
        ...
        ///  - albumCoverThumbnail: Thumbnail of the cover for the album, if
        /// available
        ...
        /// server
        ///  - performer: Performer of the audio; 0-64 characters, may be replaced
        /// by the server
        ...
        ///
        ///  - photo: Photo to send
        ///  - thumbnail: Photo thumbnail to be sent, this is sent to the other
        /// party in secret chats only
        ...
        /// characters
        ///  - ttl: Photo TTL (Time To Live), in seconds (0-60). A non-zero TTL
        ...
        ///  - width: Video width
        ///  - height: Video height
        ///  - supportsStreaming: True, if the video should be tried to be
        /// streamed
        ///  - caption: Video caption; 0-GetOption("message_caption_length_max")
        /// characters
        ///  - ttl: Video TTL (Time To Live), in seconds (0-60). A non-zero TTL
        /// can be specified only in private chats
        ...
        ///  - thumbnail: Video thumbnail, if available
        ///  - duration: Duration of the video, in seconds
        ///  - length: Video width and height; must be positive and not greater
        /// than 640
        ...
        ///  - waveform: Waveform representation of the voice note, in 5-bit
        /// format
        ...
        ///  - livePeriod: Period for which the location can be updated, in
        /// seconds; should bebetween 60 and 86400 for a live location and 0
        /// otherwise
        ...
        ///  - providerData: JSON-encoded data about the invoice, which will be
        /// shared with the payment provider
        ///  - startParameter: Unique invoice bot start_parameter for the
        /// generation of this invoice
        ...
        ///  - options: List of poll answer options, 2-10 strings 1-100 characters
        /// each
        case poll(question: String, options: [String])

        ///  A forwarded message
        ///
        ///  - fromChatId: Identifier for the chat this forwarded message came
        /// from
        ///  - messageId: Identifier of the message to forward
        ///  - inGameShare: True, if a game message should be shared within a
