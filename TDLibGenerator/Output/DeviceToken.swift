...
switch self {
case .tizenPush(let regId):
case .blackBerryPush(let token):
case .ubuntuPush(let token):
case .simplePush(let endpoint):
case .webPush(let endpoint, let p256dhBase64Url, let authBase64Url):
case .microsoftPushVoIP(let channelUri):
case .microsoftPush(let channelUri):
case .windowsPush(let accessToken):
case .applePushVoIP(let deviceToken, let isAppSandbox, let encrypt):
case .applePush(let deviceToken, let isAppSandbox):
case .firebaseCloudMessaging(let token, let encrypt):
try container.encode("deviceTokenFirebaseCloudMessaging", forKey: .init(string: "@type"))

try container.encode(token, forKey: .init(string: "token"))
try container.encode(encrypt, forKey: .init(string: "encrypt"))

try container.encode("deviceTokenApplePush", forKey: .init(string: "@type"))
...
try container.encode("deviceTokenApplePushVoIP", forKey: .init(string: "@type"))

try container.encode(deviceToken, forKey: .init(string: "deviceToken"))
try container.encode(isAppSandbox, forKey: .init(string: "isAppSandbox"))
try container.encode(encrypt, forKey: .init(string: "encrypt"))

try container.encode("deviceTokenWindowsPush", forKey: .init(string: "@type"))

try container.encode(accessToken, forKey: .init(string: "accessToken"))

try container.encode("deviceTokenMicrosoftPush", forKey: .init(string: "@type"))

try container.encode(channelUri, forKey: .init(string: "channelUri"))

try container.encode("deviceTokenMicrosoftPushVoIP", forKey: .init(string: "@type"))

try container.encode(channelUri, forKey: .init(string: "channelUri"))

try container.encode("deviceTokenWebPush", forKey: .init(string: "@type"))
...
try container.encode("deviceTokenSimplePush", forKey: .init(string: "@type"))

try container.encode(endpoint, forKey: .init(string: "endpoint"))

try container.encode("deviceTokenUbuntuPush", forKey: .init(string: "@type"))

try container.encode(token, forKey: .init(string: "token"))

try container.encode("deviceTokenBlackBerryPush", forKey: .init(string: "@type"))

try container.encode(token, forKey: .init(string: "token"))

try container.encode("deviceTokenTizenPush", forKey: .init(string: "@type"))
