...
public extension TDEnum {
    enum DeviceToken: TDEnumProtocol {
        ...
        ///
        ///  - token: Device registration token; may be empty to de-register a
        /// device
        ///  - encrypt: True, if push notifications should be additionally
        /// encrypted
        ...
        ///
        ///  - accessToken: The access token that will be used to send
        /// notifications; may be empty to de-register a device
        case windowsPush(accessToken: String)

        ///  A token for Microsoft Push Notification Service
        ///
        ///  - channelUri: Push notification channel URI; may be empty to
        ...
        ///
        ///  - endpoint: Absolute URL exposed by the push service where the
        /// application server can send push messages; may be empty to de-register
        /// a device
        ///  - p256dhBase64Url: Base64url-encoded P-256 elliptic curve
        ...
        ///
        ///  - regId: Push service registration identifier; may be empty to
        /// de-register a device
